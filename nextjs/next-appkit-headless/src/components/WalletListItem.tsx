...
export const WalletListItem = ({ wallet, onConnect, isConnecting }: WalletListItemProps) => {
  ...
  // Get the icon URL and trim any whitespace (some are base64 data URIs)
  const iconUrl = wallet.imageUrl?.trim()
  ...
  return (
    ...
    >
      {iconUrl && !imageError ? (
        // Use img tag instead of Next.js Image to handle data URIs properly
